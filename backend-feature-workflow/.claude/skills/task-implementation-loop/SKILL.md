...
- **Stan żyje na dysku** (`tasks.md` statusy + `docs/features/<slug>/state.md`), więc **świeża
  ...
  (jedna sekcja, idempotentnie: faza, taski zrobione/BLOCKED, następna komenda).
...
komenda). Wróć do (0) po kolejny task. Gdy wszystkie taski `zrobione` → zasugeruj **fazę 6**
