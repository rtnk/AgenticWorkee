...
backend-feature-workflow/
  ...
  .claude/
    ...
    scripts/
      ...
      check-quick-scope.sh               # mini-bramka zakresu dla feature-quick (checklista + diff)
...
dotykają kontraktu API, modelu danych, reguł biznesowych ani bezpieczeństwa. Żeby to nie było
